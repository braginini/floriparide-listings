...
Ext.define("Ext.locale.ru.ux.LeafletMap", {
    ...
    departureText: 'Como chegar a partir daqui',
    destinationText: 'Como chegar até aqui',
...
Ext.define("Ride.locale.ru.TripDescriptionView", {
    ...
    walkText: 'Andar',
    walkToText: 'A pé até',
    busStText: 'a parada de ônibus',
    aboutText: 'Sobre',
    busTowardsText: 'O ônibus até',
    onText: 'pela',
    turnLeftText: 'Vire à esquerda',
    turnRightText: 'Vire à direita',
    slightLeftText: 'Curva suave à esquerda',
    slightRightText: ' Curva suave à direita',
    sharpLeftText: 'Curva acentuada à esquerda',
    sharpRightText: 'Curva acentuada à direita',
    continueWalkText: 'Continue para',
    continueDriveText: ' Continue para',
