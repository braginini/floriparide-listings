...
Ext.define("Ride.locale.ru.App", {
    override: "App",
    departureText: 'Проложить маршрут отсюда',
    destinationText: 'Проложить маршрут сюда',
    sendMailText: 'Отправить письмо',
    googleMarketText: 'Ссылка на приложение в Google Play',
    tripPlanText: 'Проложить маршрут',
    routesText: 'Маршруты'
});
...
Ext.define("Ride.locale.ru.SuggestedView", {
    ...
    emptyText: 'Маршруты не найдены',
    transferText: 'пересадка',
    transfersText: 'пересадки'
});

Ext.define("Ride.locale.ru.TripDescriptionView", {
    override: "Ride.TripDescriptionView",
    walkText: 'Пешком',
    walkToText: 'Пешком до',
    busStText: 'Авт.ост.',
    aboutText: 'Примерно',
    busTowardsText: 'Автобус до',
    onText: 'по',
    turnLeftText: 'Сверните налево',
    turnRightText: 'Сверните направо',
    slightLeftText: 'Возьмите левее',
    slightRightText: 'Возьмите правее',
    sharpLeftText: 'Резкий поворот налево',
    sharpRightText: 'Резкий поворот направо',
    continueWalkText: 'Продолжайте движение',
    continueDriveText: 'Продолжайте движение',
    circularMotionText: 'Круговое движение',
    exitOnText: 'съезд',
