...
public interface IBranchDao extends IBaseEntityDao<Branch> {
	 ...
	 */
	@NotNull
	public List<Branch> getBranches(long projectId, int offset, int limit) throws Exception;
	...
	@NotNull
	//todo add order
	public List<Branch> getBranches(long projectId) throws Exception;
	 ...
	 */
	@NotNull
	public List<Branch> getBranches(long projectId, int offset, int limit, @NotNull SortField sortField, @NotNull SortType sortType) throws Exception;
}
